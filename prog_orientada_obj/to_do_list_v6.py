...
# Métodos PRIVADOS - Se usa o '_' no inicio para dizer que o método é privado. CONVENÇÃO.
# Estes pertencem apenas a classe em que está, e NÃO pode ser chamado fora dela.
# OVERLOW - Sobrecarga de métodos, ou seja, 2 métodos com mesmo nome. Python NÃO SUPORTA ISSO. Mas pode-se simular.
