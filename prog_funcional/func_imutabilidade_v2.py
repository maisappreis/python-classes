...
valores = (30, 10, 20, 70, 700) # Usando TUPLA, que são objetos IMUTAVEIS.
...
print(tuple(reversed(valores))) # inverte lista. 


# Com TUPLA não é possivel executar da forma abaixo. Não existem no contexto da TUPLA.
