...
if __name__ == "__main__":
    preco_bruto = 134.98
    preco_final = calc_preco_final(preco_bruto, imposto_x, True) # True entrou em '*params' que entrou em 'importado'.
    preco_final = calc_preco_final(preco_final, imposto_y, True, 1.5) # True e 1.5 entraram em '*params' que entraram em 'carga_explosiva e fator_perigo'.
